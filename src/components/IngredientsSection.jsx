...
export default function IngredientsSection() {
  ...
  return (
    ...
    >
      ...
      <div className="relative w-full flex flex-col items-center justify-start gap-4 max-md:gap-1.5 md:gap-6 md:max-lg:gap-2 z-10 min-h-[30vh] max-md:min-h-[24vh] md:min-h-[35vh] md:max-lg:min-h-[22vh] pt-6 max-md:pt-4 md:max-lg:pt-1">
        <div className="relative z-30 flex items-center gap-2.5 max-md:gap-1.5 md:gap-4 md:max-lg:gap-3 mb-2 md:mb-4 max-md:scale-[0.9] md:max-lg:scale-[1.14] max-md:origin-top">
      ...
      <div className="relative w-full flex items-center justify-center z-10 max-w-container-max mx-auto px-6 max-md:px-4 md:px-12 -mt-24 max-md:-mt-18 md:-mt-44 md:max-lg:-mt-80 lg:-mt-56 min-h-[45vh] max-md:min-h-[38vh] md:max-lg:min-h-[0]">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-md:gap-4 md:gap-16 lg:gap-24 md:max-lg:grid-cols-1 md:max-lg:gap-1 md:max-lg:items-center md:max-lg:justify-items-center items-center justify-items-center w-full">
          ...
          >
            <img
              className="w-[120%] max-md:w-[115%] sm:w-[130%] md:w-[145%] md:max-lg:w-[148%] lg:w-[160%] max-w-none h-auto object-contain z-20"
