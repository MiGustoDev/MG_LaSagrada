...
export default function IngredientsSection() {
  ...
  return (
    <section className="py-stack-lg bg-surface max-w-container-max mx-auto px-margin-mobile grid grid-cols-1 lg:grid-cols-2 gap-stack-lg items-center">
      {/* Images */}
      <div className="relative order-2 lg:order-1">
        <div className="relative z-10 flex flex-col -space-y-24 items-center">
          <img
            className="w-80 h-80 object-cover border-4 border-surface shadow-2xl z-20"
          ...
          />
          <img
            className="w-72 h-72 object-cover border-4 border-surface shadow-2xl z-10 -rotate-6"
        ...
        {/* Callouts */}
        <div
          className={`absolute top-0 -left-4 glass-card p-4 z-30 max-w-[150px] transition-all duration-300 ${
        ...
        <div
          className={`absolute bottom-10 -right-4 glass-card p-4 z-30 max-w-[180px] transition-all duration-300 ${
      ...
      {/* Text Content */}
      <div className="order-1 lg:order-2 flex flex-col gap-stack-md text-center lg:text-left">
        <div className="space-y-4">
          <h3 className="font-display-serif text-headline-xl text-secondary-fixed tracking-widest leading-none">
            LA SAGRADA
          </h3>
