...
export default function HeroSection() {
  ...
  return (
    <section ref={sectionRef} className="relative w-full h-screen overflow-hidden hero-gradient flex items-center justify-center group">
      ...
      <div className="relative z-10 text-center flex flex-col items-center justify-center gap-6 md:gap-8 max-w-lg px-4 max-md:absolute max-md:left-1/2 max-md:bottom-[6%] max-md:-translate-x-1/2 max-md:px-0">
