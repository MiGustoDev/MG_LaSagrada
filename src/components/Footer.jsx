export default function Footer() {
  return (
    <footer className="relative w-full" style={{
      ...
      <div className="relative z-10 max-w-container-max mx-auto px-8 md:px-16 pt-28 pb-10">
        {/* Three-column layout */}
        <div className="flex flex-col md:flex-row items-center md:items-start justify-between gap-10 md:gap-6">
          ...
          {/* CENTER — Legal text */}
          <div className="flex flex-col items-center text-center md:w-2/4 gap-3">
            <p className="font-body-md text-sm text-white leading-relaxed">
          ...
          {/* RIGHT — Social Media */}
          <div className="flex flex-col items-center md:items-end md:w-1/4 gap-4">
            <p className="font-label-sm text-xs uppercase tracking-[0.2em] text-white font-semibold">
              Seguinos en Redes
            </p>
            <div className="flex items-center gap-5">
              ...
              <a
                ...
                className="text-white hover:text-white/70 transition-colors duration-200 hover:scale-110 transform"
              >
        ...
        <div className="mt-10 pt-4 border-t border-white/20 text-center">
          <p className="font-body-md text-xs text-white/70">
            Desarrollado por el <strong className="font-bold underline">Departamento de sistemas</strong> de Mi Gusto 🥟
          </p>
        </div>
      </div>
    </footer>
